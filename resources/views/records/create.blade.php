...
<div class="page-header">
    <h1 class="page-title">📁 Create New Record</h1>
    <p class="page-subtitle">Fill in the information below to create a new record</p>
</div>
...
<div class="form-card">
    <form action="{{ route('records.store') }}" method="POST">
        ...
        <div class="form-actions">
            <a href="{{ route('records.index') }}" class="btn-secondary">Cancel</a>
