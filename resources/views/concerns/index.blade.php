...
@section('title', 'Concerns Management - CIVICLEAR')
...
<div class="page-header">
    <h1 class="page-title">📋 Concerns Management</h1>
    <a href="{{ route('concerns.create') }}" class="btn-primary">+ Manual Concern</a>
</div>
        ...
        <div class="search-filter-grid">
            ...
            <div class="form-group">
                ...
                <select name="concern_type" class="form-select">
                    ...
                    <option value="Environmental Concern" {{ request('concern_type') == 'Environmental Concern' ? 'selected' : '' }}>Environmental Concern</option>
...
<div class="table-container">
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                <td><span class="record-id">{{ $concern->record_id }}</span></td>
                ...
                <td>{{ $concern->date_submitted ? $concern->date_submitted->format('M d, Y') : 'N/A' }}</td>
                <td>{{ $concern->assigned_personnel ?? 'Unassigned' }}</td>
                <td>
                    <div class="btn-actions">
                        <a href="{{ route('concerns.show', $concern) }}" class="btn-sm btn-view">View</a>
                        <a href="{{ route('concerns.edit', $concern) }}" class="btn-sm btn-edit">Edit</a>
                    </div>
                </td>
            </tr>
            @endforeach
    ...
    <div class="empty-state">
        <p>No concerns found. Citizens can submit concerns via mobile app, or staff can manually encode.</p>
    </div>
    @endif
</div>
@endsection
