...
function safeRecord(candidate: Partial<TrackingRecord>): TrackingRecord | null {
  ...
  return {
    ...
    aiProcessingStatus: candidate.aiProcessingStatus ?? null,
  ...
  const saveSubmittedReport = useCallback(
    async (submitted: SubmittedReport, localRecordId: string, snapshot: SubmissionSnapshot) => {
      ...
      return saveRecord({
        ...
        aiProcessingStatus: submitted.aiProcessingStatus,
  ...
  const saveEnteredTrackingToken = useCallback(
    async (trackingToken: string, status?: ReportStatus) => {
      ...
      return saveRecord({
        ...
        aiProcessingStatus: status?.aiProcessingStatus ?? null,
  ...
  const updateTrackingRecordFromStatus = useCallback(
    async (localRecordId: string, status: ReportStatus) => {
      ...
      await saveRecord({
        ...
        aiProcessingStatus: status.aiProcessingStatus ?? existing.aiProcessingStatus,
