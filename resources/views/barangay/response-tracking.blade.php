...
<div class="alert alert-info shadow-sm mb-6">
    ...
    <span><strong>Transparency Dashboard:</strong> Track real-time progress of violation reports from submission to resolution for Barangay {{ $barangay }}.</span>
</div>
...
<div class="card bg-white shadow-md mb-6">
    <div class="card-body">
        <form method="GET" action="{{ route('barangay.response-tracking', $barangay) }}" class="flex flex-wrap items-end gap-3">
...
<div class="tabs tabs-boxed bg-white shadow-md mb-6 p-2">
    ...
    <a href="?status=Submitted" class="tab {{ request('status') == 'Submitted' ? 'tab-active' : '' }} text-blue-600">Submitted</a>
...
<div class="space-y-3">
        ...
        <div class="card-body p-4">
            ...
            <div class="flex items-center justify-between mb-3">
                <div class="flex items-center gap-4">
                    ...
                    <div class="text-sm">
                        <span class="text-gray-600">{{ $report->display_violation_type }}</span>
                    </div>
                </div>
    ...
    <div class="card bg-white shadow-md">
        <div class="card-body text-center py-12">
            ...
            <p class="text-gray-500">Reports for Barangay {{ $barangay }} will appear here for tracking.</p>
        </div>
    </div>
    @endforelse
</div>
