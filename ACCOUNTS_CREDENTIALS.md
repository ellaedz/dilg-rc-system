...
All barangay staff accounts use the same password: `password`
...
1. Login with: `admin@dilg.gov.ph` / `password`
2. Access all DILG admin features
3. View reports from all barangays

### Test Barangay Staff Access
1. Login with any barangay email (e.g., `poblacion-i@barangay.dilg.gov.ph`) / `password`
